...
import styles from './ActionRPG.module.css'
import axios from 'axios'

export default function ActionRpg() {

  const [actionRPGList, setActionRPGList] = useState([])

  async function getActionRPGGames() {
