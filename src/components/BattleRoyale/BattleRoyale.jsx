...
import styles from './BattleRoyale.module.css'
import axios from 'axios'


export default function BattleRoyale() {

  const [BattleRoyalList, setBattleRoyalList] = useState([])

  async function getBattleRoyalGames() {
